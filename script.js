...
const projects = [
  { title: "Skyline Residence", cat: "residential", ratio: 1.2 },
  { title: "Harbor View Villas", cat: "residential", ratio: 0.8 },
  { title: "Metro Business Park", cat: "commercial", ratio: 1 },
  { title: "Crestline Offices", cat: "commercial", ratio: 1.3 },
  { title: "Northgate Warehouse", cat: "industrial", ratio: 0.9 },
  { title: "Sunview Apartments", cat: "residential", ratio: 1.1 },
  { title: "Plaza Retail Front", cat: "commercial", ratio: 0.85 },
  { title: "Ironline Shed Complex", cat: "industrial", ratio: 1.15 },
  { title: "Lakeside Bungalow", cat: "residential", ratio: 1 }
];
...
projects.forEach((p, i) => {
  ...
  item.innerHTML = `
    ${projectSvg(p.title, p.cat, i, p.ratio)}
